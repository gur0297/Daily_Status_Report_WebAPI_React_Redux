...
namespace Daily_Status_Report_task.Controllers
{
    ...
    public class StatusController : ControllerBase
    {
        ...
        [HttpGet]
        public IEnumerable<StatusTable> GetUsers()
        {
            return _statusRepository.GetAllReports();
        }

        [HttpGet("{statusId}")]
        public ActionResult<IEnumerable<StatusTable>> GetBookingsByUserId(int id)
        {
            var bookings = _statusRepository.GetReportById(id);
            return Ok(bookings);
        }
